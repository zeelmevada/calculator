...
var btnop = document.getElementById('tes1')

btnop.addEventListener("click", () => {
    let lastchartest = display.value.charAt(display.value.length -1)
    let lasteval = eval(lastchartest)
    txt.innerHTML +=  lastchartest
})
